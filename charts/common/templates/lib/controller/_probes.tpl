...
*/}}
{{- define "tc.common.v10.controller.probes" -}}
{{- $primaryService := get .Values.service (include "tc.common.v10.lib.util.service.primary" .) -}}
{{- $primaryPort := "" -}}
{{- if $primaryService -}}
  {{- $primaryPort = get $primaryService.ports (include "tc.common.v10.lib.util.service.ports.primary" (dict "serviceName" (include "tc.common.v10.lib.util.service.primary" .) "values" $primaryService)) -}}
{{- end -}}
{{- $probeType := "TCP" -}}
