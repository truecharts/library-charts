...
{{- define "tc.common.v10.controller.mainContainer" -}}
- name: {{ include "tc.common.v10.names.fullname" . }}
  image: {{ include "tc.common.v10.images.selector" . }}
  ...
  {{- end }}
  ports:
  {{- include "tc.common.v10.controller.ports" . | trim | nindent 4 }}
  {{- with (include "tc.common.v10.controller.volumeMounts" . | trim) }}
  volumeMounts:
    {{ nindent 4 . }}
  {{- end }}
  {{- include "tc.common.v10.controller.probes" . | trim | nindent 2 }}
  {{/*
