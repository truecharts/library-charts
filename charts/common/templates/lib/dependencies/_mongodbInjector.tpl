...
{{- end }}
  ...
  urlreplicasetoplog: {{ ( printf "mongodb://root:%v@%v-mongodb:27017/local?authSource=admin&?replicaSet=%v" $rootPass .Release.Name .Values.mongodb.mongodbReplicasetName ) | b64enc | quote }}
