{{- define "tc.common.v10.scale.cert.secret" -}}

{{- $secretName := include "tc.common.v10.names.fullname" . -}}
...
{{- if eq (include "tc.common.v10.scale.cert.available" $ ) "true" -}}
...
metadata:
  ...
  labels: {{ include "tc.common.v10.labels" . | nindent 4 }}
type: kubernetes.io/tls
data:
  tls.crt: {{ (include "tc.common.v10.scale.cert.publicKey" $ ) | toString | b64enc | quote }}
  tls.key: {{ (include "tc.common.v10.scale.cert.privateKey" $ ) | toString | b64enc | quote }}
{{- end -}}
{{- end -}}
